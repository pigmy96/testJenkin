...
<div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Album Information - EDIT ALBUM</h3>
            </div>
            ...
            <form:form modelAttribute="albumForm" method="POST" enctype="multipart/form-data">
              <div class="box-body">
               ...
               <div class="form-group">
				...
				<div class="form-group">
               <div class="thumbnail">
				<img id="previewImage" src="${pageContext.request.contextPath}/album/albumImage?id=${albumID}" alt="..." class="img-responsive upload">
               </div>
               	
                  <label for="exampleFileData">Upload Image</label>
